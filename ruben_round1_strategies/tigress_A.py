"""Hybrid A: Alex base + V4/V5 L2 wall detection for penny-jump.
Skips Bot3 noise at L1, always penny-jumps the real wall (L2).
...
class Trader:
    ...
    # V4/V5 wall detection: skip L1 noise, find the real wall
    ...
    def _trade_osmium(self, od: OrderDepth, position: int, td: dict):
        ...
        # PASSIVE: V4/V5 wall detection + penny-jump
