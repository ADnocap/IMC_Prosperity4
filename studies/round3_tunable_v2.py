"""Tunable trader for search 2 — defaults are trial #324 (winner of
search 1). Same logic as round3_tunable.py / harry_potter_v4; only the
PARAMS defaults differ. Params not listed in the search 2 YAML stay
locked at #324's values."""
...
class Trader:
    # === Trial #324 winner defaults (search 1) ===
    # MR core
    ...
    # Categorical toggles (LOCKED at #324 winners)
    OBI_CONFIRM_TAKE = True
    INCLUDE_5400_MR = True
    INCLUDE_5500_MR = False
    DISABLE_TAKES = False  # NEW for search 2: if True, never cross spread
    ...
    def __init__(self):
        ...
        # Asset routing based on toggles (#324: 5500 is OBI MM)
    ...
    def _trade_mr(self, product: str, od: OrderDepth, pos: int, td: dict) -> List[Order]:
        ...
        # Cross-spread take (DISABLE_TAKES gates everything; OBI_CONFIRM gates further)
