...
HL_PER_ASSET: Tuple[int, ...] = (
    ...
    0, 0, 0, 1270, 1108, 0, 966, 1457, 0, 1500,
    1108, 0, 500, 966, 0, 0, 0, 0, 734, 1457,
    0, 842, 1671, 0, 1671, 0, 0, 0, 1457, 0,
    0, 0, 0, 1916, 0, 734, 1500, 966, 734, 640,
)
...
TRIPLET_KAPPA = 3.0   # half of snackpack.py's 6 since v12 already has per-asset MR

# Snackpack Bollinger range-pos overlay on PIS + RASP only
HL_RANGE = 200
RANGE_TARGETS = frozenset([SP_PIS, SP_RASP])
RANGE_KAPPA = 1.5     # half of snackpack.py's 3 since v12 already has per-asset MR
