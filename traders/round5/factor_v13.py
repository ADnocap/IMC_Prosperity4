"""Round 5 factor_v9 — v7 + pure MM on the signal-disabled (RW + slow OU) assets.
...
HL_PER_ASSET: Tuple[int, ...] = (
    ...
    1108, 0, 1000, 1000, 300, 0, 0, 0, 1000, 1457,
    0, 1000, 1671, 0, 1671, 0, 0, 0, 1457, 0,
    0, 300, 0, 500, 0, 1000, 1500, 1000, 1000, 1000,
)
    ...
    def run(self, state: TradingState):
        ...
        for i, sym in enumerate(ASSETS):
            ...
            if EMA_ALPHA[i] > 0 or i in (ASSET_IDX[SP_CHOC], ASSET_IDX[SP_VAN]):
                ...
                # ---- MM layer (no signal — target 0, mean-revert pos to 0) ----
                if pos > 0:
