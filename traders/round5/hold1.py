"""R5 hold-1 trader: at t=0 buy 1 unit of every product, then hold forever.

Used for FV extraction + sim validation. Identical logic to portal sub
545243 (-2159.50 PnL on day-4 1K-tick portal-UI backtest), with R5 symbol
declarations at the top so the Rust MC sim's `detect_assets` can pick them
up.
"""
# 50 R5 products — required for Rust MC sim symbol detection.
