"""Round 5 factor_v4 â€” best-of-both: v3's signal generator + v1's directional-only execution.
...
harvest**. The MM tail trades drift PnL for tiny spread PnL â€” net negative.
...
----------------------------------
  ...
  target     = round(clip(signal, Â±TARGET_FRAC) * POS_LIMIT)
