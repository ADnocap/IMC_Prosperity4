...
class Trader:
    ...
    def _trade_osmium(self, od: OrderDepth, position: int, td: dict):
        ...
        # v4: tight-spread MM. Post inside the spread at FV±3 instead of FV±7.
        # Hypothesis: if portal elastic rate scales with quote attractiveness, we
        # get more fills to compensate for the lost edge per fill.
