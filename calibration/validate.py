"""
Rigorous calibration validation harness.

Reads each asset's extracted fv_and_book.json and runs chi-squared / z-tests against
the calibrated bot rules. Asset-agnostic — add a (NAME, path) tuple to `PRODUCTS` for
any new asset that already has `calibration/<asset>/data/fv_and_book.json`.
